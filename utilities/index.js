...
Util.buildSingleView = async function (vehicle) {
  ...
  if (vehicle) {
    view += '<section id="vehicle-details">'        
    ...
    view += `<h2>${vehicle.inv_year} ${vehicle.inv_make} ${vehicle.inv_model}</h2>`
    ...
    view = '<p class="notice">Sorry, that vehicle could not be found.</p>'
  }
...
/* ****************************************
  * Builds the classification dropdown list
  * **************************************** */
